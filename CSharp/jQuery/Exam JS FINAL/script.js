...
let fromCompanyTransaction = []; // Array to store transactions from Company 1
let toCompanyTransaction = []; // Array to store transactions from Company 2
...
function renderTransactions(data) {
    ...
    const { fromCompanyTransaction, toCompanyTransaction } = data; // obj properties to variables called destructuring

    // show data only that is not reconciled, not excluded, and do not have the isReconciled property
    ...
    const handleDrop = (event) => {
        ...
        // Log the selected transaction ID
